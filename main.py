...
from database.queries import insert_vk_post,insert_publication, add_assesment,get_all_active_tg_sources, get_last_publications,get_all_active_vk_sources, add_mention
...
async def parse_publications():
    ...
    tg_posts = await parse_tg_async(52, tg_sources)
